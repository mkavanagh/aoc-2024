...
@line_input()
def get_antinode_uniques(lines: list[str]) -> int:
    return _get_antinode_uniques(lines, _polar_antinode_generator)


@line_input()
def get_antinodes(lines: list[str]) -> str:
    return _get_antinodes(lines, _polar_antinode_generator)


@line_input()
def get_resonant_antinode_uniques(lines: list[str]) -> int:
    return _get_antinode_uniques(lines, _resonant_antinode_generator)


@line_input()
def get_resonant_antinodes(lines: list[str]) -> str:
    return _get_antinodes(lines, _resonant_antinode_generator)


def _get_antinode_uniques(
    lines: list[str], generator_factory: AntinodeGeneratorFactory
) -> int:
